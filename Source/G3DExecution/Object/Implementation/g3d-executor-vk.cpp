...
#include "g3d-executor-render-target-info-vk.h"
...
void G3DExecutorVk::executeCommandList(IG3DCommandList_T *commandList, IG3DExecutorRenderTargetInfo_T* renderWindowInfo)
{   
    ...
    if (renderWindowInfo) {
        waitSemaphore = dynamic_cast<G3DExecutorRenderTargetInfoVk*>(renderWindowInfo)->getImageAvailableSemaphore();
        signalSemaphore = dynamic_cast<G3DExecutorRenderTargetInfoVk*>(renderWindowInfo)->getRenderFinishedSemaphore();
    }
