...
enum G3DPipelineBindingType {
    ...
    G3DImageViewRead = 0b1 << 1U,
    G3DImageViewWrite = 0b1 << 2U,
    G3DSampler = 0b1 << 3U
};
...
struct G3DBindingUpdate {
    ...
    virtual ~G3DBindingUpdate() = default;
};

enum class G3DReadWriteType {
    READ,
    WRITE
};

struct G3DImageViewBindingUpdate : public G3DBindingUpdate {
    G3DReadWriteType readWriteType;
    ~G3DImageViewBindingUpdate() override {};
};

struct G3DBufferViewBindingUpdate : public G3DBindingUpdate {
    ~G3DBufferViewBindingUpdate() override {};
};

struct G3DSamplerBindingUpdate : public G3DBindingUpdate {
    ~G3DSamplerBindingUpdate() override {};
};
