...
class IG3DPipelineFactory_T {
    protected:
    class IG3DDevice_T* m_device;
    public:
    IG3DPipelineFactory_T(class IG3DDevice_T* device) : m_device(device) {}
    virtual ~IG3DPipelineFactory_T() = default;
    ...
    virtual class IG3DComputePipeline_T* createComputePipeline(struct G3DComputePipelineInfo* createInfo,
        class IG3DResourceSetSignature_T** supportedSignatures, uint32_t supportedSignatureCount) = 0;
};