#include "g3d-windowing/g3d-render-window-factory-vk.h"
...
IG3DRenderWindow_T *G3DRenderWindowFactoryVk::createRenderWindow(IG3DApplication_T* application,
    IG3DDevice_T* device, IG3DResourceFactory_T* resourceFactory, int height, int width)
{
    ...
    renderWindow->m_renderTargetInfo = new G3DExecutorRenderTargetInfoVk();
