...
static uint32_t getSuitableMemoryTypeIndex(VkPhysicalDevice physicalDevice, VkMemoryRequirements memoryRequirements, VkMemoryPropertyFlags propertyFlags)
{
...
static int getVkFormatFromG3DFormat(G3DFormat format)
{
...
static int getVkFormatSizeFromG3DFormat(G3DFormat format)
{
    int size;
    switch(format) {
        case G3DFormat::RGBA8_UNORM:
